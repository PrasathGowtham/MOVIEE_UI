...
function Loginpage() {
    ...
    return (
        <div style={{ backgroundColor: "#8E8D8A" }}>
            ...
            <div className="login row" >
                ...
                <div className="col-md-12">
                    ...
                    <div style={{ padding: "10px" }}> <a class="btn btn-primary" href="#" role="button" onClick={handelSubmit}>Signin</a></div>

                    <div style={{ padding: "10px" }}> <span style={{ margin: "10px" }}>did't have an account?</span><a class="btn btn-primary" href="#" role="button" onClick={() => navigate("/signup")}>Signup</a></div>
                </div>
            </div>
        </div>
    )
